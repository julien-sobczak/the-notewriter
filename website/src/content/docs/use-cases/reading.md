...
_The NoteWriter_ is not designed to collect your notes, only to store and use them as much as possible.

There are many options to collect your notes while reading. You can master the art of marginalia and annotate your physical books in the margins. You can use an e-reader with an electronic pen and export your notes in a digital file. You can take your note along your reading on your phone. You just have to collect some notes about what resonates.
...
* _Second Brain_ (Since a decade) = "How will I use this?"
  * Knowledge exists to **support action**. Notes are often tied to outcomes and the focus on a completing projects. A digital tool is required.

_The NoteWriter_ can accommodate any of these systems:

* Use different Markdown files for different themes to build your commonplace book.
* Use Markdown links or Wikilinks to link atomic notes to buld your Zettelkasten.
* Use directories for projects/areas/resources (**PAR**A) (the last A for archival is not necessarily when using Git) to build your Second Brain
...
_The NoteWriter_ supports an addition command `nt-book` to generate books from your notes (ePUB or PDF).
...
* You will sometimes create [flashcards from your reading notes](./learning.md) to remember more of what you read.
* You will use your notes as materials when [writing](./writing.md) a new blog post or any other [creative activity](./creating.md).
