...
You can organize your Markdown files using a tree structure. Check the [directory `example/`](https://github.com/julien-sobczak/the-notewriter/tree/main/example) to have a better idea of what a note repository could look like.
...
* **Use Markdown headings to organize your notes** to group similar notes under the same section.
* **Use special Markdown headings to define your notes**.
