...
# Goto Link Placeholders: Special Syntax

Goto links in The NoteWriter support advanced placeholders in their URLs, allowing you to define variables that can be filled in dynamically. This enables flexible linking to resources with variable parts, such as user profiles, repositories, or filtered views.
